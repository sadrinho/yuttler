...
const ShareIcon = () => (
  // safari's share button: a box with an arrow coming out the top
  <svg
    viewBox="0 0 24 24"
    width="16"
    height="16"
  ...
  >
    <path
      d="M8 9H6.5A1.5 1.5 0 0 0 5 10.5v8A1.5 1.5 0 0 0 6.5 20h11a1.5 1.5 0 0 0 1.5-1.5v-8A1.5 1.5 0 0 0 17.5 9H16"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinecap="round"
    />
    <path
      d="M12 14V3.5M8.5 7 12 3.5 15.5 7"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinecap="round"
...
function GetTheApp() {
  ...
  return (
    <section className={styles.section}>
      <div className={styles.label}>Ditch the website</div>
      ...
      >
        ...
        <span className={styles.rowText}>Get the App</span>
        <svg
          viewBox="0 0 24 24"
          width="16"
          height="16"
